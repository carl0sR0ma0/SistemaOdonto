...
{
    public partial class ConPaciente : Form
    {
        ...
        public void IniciarForm()
        {
            ...
            if (lista == null)
            {
                MessageBox.Show("Não exitem dados cadastrados");
            }
            else
            {
                char letraAnterior = '#';
                ...
                foreach (var dado in lista)
                {
                    ...
                    else
                    {
                        ...
                        data = dg;
                        tc.TabPages[numeroTabela].Controls.Add(dg);
                        GerarTabela(dg);
                        GerarLinha(dg, dado);
                    }
        ...
        private void tb_click(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                if (e.ColumnIndex == 1 && e.RowIndex != -1)
                {
                    ...
                    var form = new EditarPaciente(obj);
                    form.ShowDialog();
