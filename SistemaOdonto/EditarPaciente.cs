...
namespace SistemaOdonto
{
    public partial class EditarPaciente : Form
    {
        ...
        public EditarPaciente(Paciente obj)
        {
            InitializeComponent();
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (ts.Text == "Sucesso")
            {
                ...
                {
                    status = "apagado";
                    MessageBox.Show("Este de Registro acabou de ser excluido por outro usuário");
                }
                else
                {
                    status = "editado";
                    ...
                    this.obj.Nascimento = Convert.ToDateTime(dtDataNasc.Value);
